...
const makeMiddleEarth = () => {
  ...
  for (let i = 0; i < lands.length; i++){
    const $article = $(`<article/>`).attr('id',lands[i]).html(`<h1>${lands[i]}</h1>`);
...
const makeHobbits = () => {
  ...
  for (let i = 0; i < hobbits.length; i++){
    $ulHobbits.append($('<li/>').attr('class','hobbit').text(hobbits[i]));
  }
...
const keepItSecretKeepItSafe = () => {
  ...
  const $divRing = $('<div/>').attr('id','the-ring');
...
const makeBaddies = () => {
  ...
  for (let i = 0; i < baddies.length; i++){
    $ulBaddies.append($('<li/>').attr('class','baddy').text(baddies[i]));
  }
...
const makeBuddies = () => {
  ...
  for (let i = 0; i < buddies.length; i++){
    $ulBuddies.append($('<li/>').attr('class','buddy').text(buddies[i]));
  }
...
const theBalrog = () => {
  ...
  const $gandalf = $('#the-fellowship .buddy')[0];
